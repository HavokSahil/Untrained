...
import 'package:frontend/screens/user/booking_category_screen.dart';
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(user: widget.user, title: "Booking ~ Choose your Journey"),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () => {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => BookingCategoryScreen(
                                user: widget.user,
                                journey: journey,
                              ),
                            ),
